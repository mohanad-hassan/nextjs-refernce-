...
//when you rewrite the Head in normal pages it will MERGE them and  rewrite the same attributes and tags  Head  in _app.js file .
//if you set more than one Head in the same page it will merge them but the last one is more powerfull .
//
